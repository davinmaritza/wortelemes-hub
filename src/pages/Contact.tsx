  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-16">
        ...
        <div className="max-w-md mx-auto text-center space-y-6 opacity-0 animate-fade-in-up delay-200" style={{ animationFillMode: 'forwards' }}>
          <div>
          ...
          <div>
            ...
            <span className="text-foreground font-body text-lg">{contact.discord}</span>
          </div>
        </div>
      </main>
