...
const ContactSection = ({ aboutMe }: ContactSectionProps) => {
  return (
    <section id="contact" className="py-20 bg-card">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-foreground mb-10 text-center">Contact</h2>
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="space-y-4">
            ...
            <a 
              href="https://discord.com/users/wortelemes"
              target="_blank"
