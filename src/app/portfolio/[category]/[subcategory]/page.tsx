  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        ...
        <div className="mt-8">
          <h2
            className="font-display text-2xl md:text-3xl text-center text-foreground mb-4 opacity-0 animate-fade-in-up"
            style={{
          ...
          {description && (
            <p
              className="text-muted-foreground font-body text-center max-w-2xl mx-auto mb-8 opacity-0 animate-fade-in-up"
              style={{
                animationFillMode: "forwards",
          ...
          <div
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto opacity-0 animate-fade-in-up"
            style={{
              animationFillMode: "forwards",
